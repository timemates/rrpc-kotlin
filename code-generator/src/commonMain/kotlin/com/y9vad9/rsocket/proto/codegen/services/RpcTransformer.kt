...
import com.y9vad9.rsocket.proto.codegen.protoTransformer

internal val RpcTransformer: Transformer<Rpc, FunSpec> = protoTransformer { rpc ->
...
private val RpcTypeTransformer: Transformer<Rpc, Pair<TypeName, TypeName>> = protoTransformer { rpc ->
...
private val RpcNameTransformer: Transformer<ProtoType?, ClassName> = protoTransformer { type ->
