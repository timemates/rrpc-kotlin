...
import app.timemate.rrpc.server.ServicesContainer
...
public interface RRpcModule : InstanceContainer, ServicesContainer {
     ...
     *
     * Interceptors are instances of the [app.timemate.rrpc.interceptors.RRpcInterceptor] interface.
     *
     * @see [app.timemate.rrpc.interceptors.RRpcInterceptor]
     */
